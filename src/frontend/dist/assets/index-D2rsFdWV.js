...
const THUMBNAIL_URL = "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=120&q=70";
const MAIN_IMAGE_URL = "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&q=85";
const thumbnails = [
...
function ProductPage() {
  ...
  const prev = () => setActiveThumb((i) => (i - 1 + thumbnails.length) % thumbnails.length);
  const next = () => setActiveThumb((i) => (i + 1) % thumbnails.length);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white font-sans", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "nav",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Pipe for Site Header" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "product.panel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-xl overflow-hidden bg-gray-100 aspect-[4/3] mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 overflow-x-auto pb-1", children: thumbnails.map((thumb, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => setActiveThumb(i),
              "data-ocid": `product.item.${i + 1}`,
              className: `flex-shrink-0 w-16 h-16 rounded-lg overflow-hidden border-2 transition ${activeThumb === i ? "border-teal-500 ring-2 ring-teal-200" : "border-transparent hover:border-gray-300"}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: certifications.map((cert) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(BadgeCheck, { className: "w-3.5 h-3.5 text-teal-500" }),
                cert
              ]
            },
            cert
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl sm:text-3xl font-bold text-gray-900 leading-tight", children: "Premium HDPE Pipes & Coils for Modern Infrastructure" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: bullets.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "li",
            {
              className: "flex items-center gap-2.5 text-sm text-gray-700",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-teal-500 flex-shrink-0" }),
                b
              ]
            },
            b
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1", children: "Price Range" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-gray-900", children: "₹4,80,000 – 7,90,000" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium bg-blue-50 text-blue-700 border border-blue-100", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { className: "w-3.5 h-3.5" }),
              "Shipping: 4–12 days"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium bg-amber-50 text-amber-700 border border-amber-100", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
            "Certifications:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: "ISO Certified, BIS Certified" })
          ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-y border-gray-100 py-8 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-6 tracking-wide uppercase", children: "Trusted by Hundreds of Companies Globally" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center items-center gap-8", children: euroflexBrands.map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[#1a1f2e] py-14 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl sm:text-3xl font-bold text-white text-center mb-3", children: "Technical Specifications at a Glance" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400 text-center mb-10 max-w-2xl mx-auto", children: "Comprehensive performance data demonstrating our commitment to quality and engineering excellence." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl overflow-hidden border border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", "data-ocid": "product.table", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-white/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-3 text-left text-xs font-semibold text-gray-400 uppercase tracking-widest w-1/2", children: "Parameter" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-3 text-left text-xs font-semibold text-gray-400 uppercase tracking-widest", children: "Specification" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: specs.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            "data-ocid": `product.row.${i + 1}`,
            className: i % 2 === 0 ? "bg-[#1e2436]" : "bg-[#232840]",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3.5 text-gray-300 font-medium", children: row.param }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3.5 text-gray-200", children: row.spec })
            ]
          },
          row.param
        )) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-[#151922] py-5 text-center text-xs text-gray-500", children: [
      "© ",
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient$1, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ProductPage, {}),
